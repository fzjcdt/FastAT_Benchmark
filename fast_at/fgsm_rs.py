...
class FGSMRS(ATBase):
    ...
    def __init__(self, model, config_path=None, config=None, log_dir='./log/', name='fgsm_rs', device=None, seed=0):
        super(FGSMRS, self).__init__(model, config_path=config_path, config=config, 
    ...
    def train(self, opt, scheduler, train_loader, val_loader, test_loader=None):
        ...
        for epoch in range(total_epoch):
            ...
            for images, labels in train_loader:
                ...
                # alpha = 1.25 * eps
                adv_images = adv_images.detach() + self.eps * 1.25 * adv_images.grad.detach().sign()
