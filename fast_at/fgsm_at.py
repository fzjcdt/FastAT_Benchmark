...
class FGSMAT(ATBase):
    ...
    def __init__(self, model, config_path=None, config=None, log_dir='./log/', name='fgsm_at', device=None, seed=0):
        super(FGSMAT, self).__init__(model, config_path=config_path, config=config, 
